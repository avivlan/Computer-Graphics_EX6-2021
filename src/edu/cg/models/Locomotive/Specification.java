...
public final class Specification {
    ...
    //Backwindow:
    public static final double BACKWINDOW_DEPTH = EPS;
    public static final double BACKWINDOW_HEIGHT = 2 * BASE_UNIT;
    public static final double BACKWINDOW_WIDTH = 3 * BASE_UNIT;
